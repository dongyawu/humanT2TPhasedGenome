...
$threads=40;
$minimap2="/slurm/soft/canu/2.2/bin/minimap2";
...
system(qq(sh /slurm/users/wudongya/software/asm2ref/unimap/run_unimap_dotplot.sh /slurm/users/wudongya/APG/reference/CHM13v2m.fasta ${prefix}.paf.fasta ${prefix}_CHM13v2m));
